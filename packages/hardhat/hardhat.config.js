...
module.exports = {
  ...
  networks: {
    ...
    goerli: {
      url: "https://eth-goerli.g.alchemy.com/v2/dGWgZ4GG916AFgSvsJjpjr5WrJnjtKmI", // <---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    ...
    goerliOptimism: {
      url: "https://opt-goerli.g.alchemy.com/v2/h_-n5x_H-5OX0uS4_dgm944Er8RxQF07",
      accounts: {
        mnemonic: mnemonic(),
      },
      companionNetworks: {
  ...
  etherscan: {
    apiKey: "QMP1FA66IBMXKV6BCYKQNR7KQK8YXNNN83",
  },
};
